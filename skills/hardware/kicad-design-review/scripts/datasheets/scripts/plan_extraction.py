...
ALWAYS_TASKS = {
    "base":   ("base",   "B", "schemas/base.schema.json",
               "prompts/base.md"),
    "pinout": ("pinout", "A", "schemas/pinout.schema.json",
               "prompts/pinout.md"),
}
CATEGORY_TASKS = {
    "regulator":  ("regulator",  "B", "schemas/regulator.schema.json",
                   "prompts/regulator.md"),
    "diode":      ("diode",      "B", "schemas/diode.schema.json",
                   "prompts/diode.md"),
    "transistor": ("transistor", "B", "schemas/transistor.schema.json",
                   "prompts/transistor.md"),
    "opamp":      ("opamp",      "B", "schemas/opamp.schema.json",
                   "prompts/opamp.md"),
    "mcu":        ("mcu",        "B", "schemas/mcu.schema.json",
                   "prompts/mcu.md"),
    "crystal":    ("crystal",    "B", "schemas/crystal.schema.json",
                   "prompts/crystal.md"),
